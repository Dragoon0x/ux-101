...
---
# Form Accessibility
**Purpose:** Apply form accessibility with the rigor that makes it genuinely useful — grounded in user evidence, informed by established practice, and adapted to the specific product context.

## The Practice
Accessibility is a fundamental design quality, not an add-on. 15-20% of people have some form of disability. Accessible design benefits everyone — captions help in noisy environments, high contrast helps in bright sunlight, keyboard support helps power users. WCAG provides the standard. Real users provide the validation. For form accessibility specifically, the implementation should be informed by research (what do users need?), constrained by principles (what does good practice say?), and validated by testing (does it actually work?). Assumptions are hypotheses until tested.
