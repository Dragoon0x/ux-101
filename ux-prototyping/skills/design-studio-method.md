...
**Purpose:** Apply design studio method with the rigor that makes it genuinely useful — grounded in user evidence, informed by established practice, and adapted to the specific product context.

## The Practice
Prototyping is the fastest way to learn. The goal is answering a design question, not building a miniature product. Match fidelity to the question — paper sketches for concept validation, interactive prototypes for flow testing, high-fidelity prototypes for visual refinement. The prototype is disposable; the learning is permanent. For design studio method specifically, the implementation should be informed by research (what do users need?), constrained by principles (what does good practice say?), and validated by testing (does it actually work?). Assumptions are hypotheses until tested.
